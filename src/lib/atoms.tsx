...
export const Wrapper = tw.section`mx-auto w-full snap-always snap-center mx-auto px-6 lg:px-0 relative z-0`;
...
export const PreHeading = tw.h4`uppercase text-xs tracking-widest font-semibold text-brand-primary w-full opacity-90 subpixel-antialiased dark:text-brand-g1`;
